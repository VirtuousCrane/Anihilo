...
public class Score_Part {
    public Score_Part(JFrame main_page) {
        ...
        JLabel score = new JLabel(
                Utils.toHTML("<p style='font-size:20px; text-align:center;'>Score<br />" + score_test + "</p>"));
        ...
        JLabel guess = new JLabel(
                Utils.toHTML("<p style='font-size:20px; text-align:center;'>Guess<br />" + guess_test + "</p>"));
        ...
        JLabel accuracy = new JLabel(
                Utils.toHTML("<p style='font-size:20px; text-align:center;'>Accuracy<br />" + accuracy_test + "</p>"));
